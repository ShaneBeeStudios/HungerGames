...
//				}
//			}
//			Util.sendMini(sender, lang.cmd_stop_all);
//			return true;
//		}
//		Game g = gameManager.getGame(args[1]);
//		if (g != null) {
//			g.stop(false);
//			Util.sendMini(sender, lang.cmd_stop_arena.replace("<arena>", args[1]));
//		} else {
//			Util.sendMini(sender, lang.cmd_stop_noexist.replace("<arena>", args[1]));
//		}
		return true;
	}
}
